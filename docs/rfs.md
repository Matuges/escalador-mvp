...
RF32 — O sistema deve permitir filtrar a visualização de pessoas por função e ministério.
RF33 — O sistema deve permitir selecionar cultos fixos.
RF34 — O sistema deve permitir gerar cultos fixos de um ano inteiro.
RF35 — O sistema deve paginar os cultos de acordo com o mês. 
RF36 — O sistema deve diferenciar os tipos de culto por cor para facilitar a visibilidade
